 ...
 */
class Save extends \Beeapps\AttributesManagement\Controller\Adminhtml\Customer\Attribute implements HttpPostActionInterface
{
    /**
    ...
    public function __construct(
        ...
        \Magento\Framework\View\Result\PageFactory $resultPageFactory = null
    ) {
    ...
    public function execute()
    {
        try {
            ...
            return $this->returnResult('bam/*/edit', ['_current' => true], ['error' => true]);
        }
