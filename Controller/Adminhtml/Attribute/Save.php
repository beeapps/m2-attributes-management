...
namespace Beeapps\AttributesManagement\Controller\Adminhtml\Attribute;
 ...
 */
class Save extends \Beeapps\AttributesManagement\Controller\Adminhtml\Customer\Attribute
{
    ...
    public function __construct(
        ...
        \Magento\Framework\Cache\FrontendInterface $attributeLabelCache = null
    ) {
        parent::__construct($context, $helper, $attributeLabelCache, $coreRegistry, $resultPageFactory);
        $this->helper = $helper;
        ...
        if ($data) {
            ...
            if ($attributeId) {
                ...
                if (!$model->getId()) {
                    ...
                    return $this->returnResult('bam/*/', [], ['error' => true]);
                }
                ...
                $data['source_model'] = $this->helper->getAttributeSourceModelByInputType(
                    $data['frontend_input']
                );
                $data['backend_model'] = $this->helper->getAttributeBackendModelByInputType(
                    $data['frontend_input']
                );
            }
            ...
            try {
                ...
                return $this->returnResult('bam/*/', [], ['error' => false]);
            } catch (\Exception $e) {
