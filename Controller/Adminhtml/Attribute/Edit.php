...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Beeapps_AttributesManagement::save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Beeapps_AttributesManagement::customer_attributes')
    ...
    protected function createActionPage($title = null)
    {
        ...
        $resultPage->addBreadcrumb(__('Customer'), __('Customer'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Customer Attributes'))
            ->setActiveMenu('Beeapps_AttributesManagement::customer_attributes');
        if (!empty($title)) {
