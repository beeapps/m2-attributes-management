 ...
 */
namespace Beeapps\AttributesManagement\Ui\DataProvider\Customer\Attributes;
...
/**
 * Class DataProvider
 * @package Beeapps\AttributesManagement\Ui\DataProvider\Customer\Attributes
 */
    ...
    private function customizeOptions($meta)
    {
        ...
        foreach ($this->storeRepository->getList() as $store) {
            ...
            $storeLabelConfiguration = [
                'dataType' => 'text',
                'formElement' => 'input',
                'component' => 'Beeapps_AttributesManagement/js/form/element/input',
        ...
        ['record']['children']['action_delete'] = $this->arrayManager->set(
            ...
            [
                ...
                'fit' => true,
                'sortOrder' => $sortOrder,
                'component' => 'Beeapps_AttributesManagement/js/form/element/action-delete',
                'elementTmpl' => 'Beeapps_AttributesManagement/form/element/action-delete',
                'template' => 'Beeapps_AttributesManagement/form/element/action-delete',
