 ...
 *
 */
namespace Beeapps\AttributesManagement\Block\Adminhtml\Attribute;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
     ...
     * @var string
     */
    protected $_blockGroup = 'Beeapps_AttributesManagement';
    ...
    protected function _construct()
    {
        ...
        if (!$entityAttribute || !$entityAttribute->getIsUserDefined()
                || !$this->_isAllowedAction('Beeapps_AttributesManagement::attribute_delete')) {
            $this->buttonList->remove('delete');
        } else {
            $this->buttonList->update('delete', 'label', __('Delete Attribute'));
        }
        
        if ((!$this->_isAllowedAction('Beeapps_AttributesManagement::save')) ||
